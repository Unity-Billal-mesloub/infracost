...
Infracost supports over **1,100** Terraform resources across [AWS](https://www.infracost.io/docs/supported_resources/aws), [Azure](https://www.infracost.io/docs/supported_resources/azure) and [Google](https://www.infracost.io/docs/supported_resources/google). Other IaC tools, such as [Pulumi](https://github.com/Unity-Billal-mesloub/infracost/issues), [AWS CloudFormation/CDK](https://github.com/Unity-Billal-mesloub/infracost/issues) and [Azure ARM/Bicep](https://github.com/Unity-Billal-mesloub/infracost/issues) are on our roadmap.
